...
export function HowItWorks() {
  return (
    <section className='border-t border-[rgba(194,178,128,0.10)] py-24'>
      ...
      <div className='container relative mx-auto px-6'>
        <FadeIn>
          <div className='mb-16 text-center'>
            ...
            <p className='mx-auto max-w-2xl text-lg text-[#E5DDC8] opacity-60'>
            ...
            <FadeIn key={step.number} delay={index * 0.15}>
              <div className='relative'>
                ...
                {index < steps.length - 1 && (
                  <div className='absolute left-1/2 top-14 z-0 hidden h-px w-full bg-gradient-to-r from-[rgba(194,178,128,0.25)] to-transparent md:block' />
                )}

                <div
                  className='
                  relative z-10 rounded-2xl p-8 text-center
                  border border-[rgba(194,178,128,0.12)]
                  bg-[rgba(17,17,22,0.75)] backdrop-blur-sm
                  transition-all duration-300
                  hover:border-[rgba(194,178,128,0.30)]
                  hover:shadow-[0_8px_32px_rgba(194,178,128,0.12)]
                '
                >
                  {/* Step number circle */}
                  <div className='mb-6 flex justify-center'>
                    <div
                      ...
                      border-2 border-[rgba(194,178,128,0.35)]
                      bg-[rgba(194,178,128,0.08)]
                      text-xl font-bold text-[#C2B280]
                    '
                    >
                      {step.number}
                    </div>
                  ...
                  <p className='text-sm leading-relaxed text-[#E5DDC8] opacity-60'>
                    {step.description}
                  </p>
                  ...
                  {index === steps.length - 1 && (
                    <div className='mt-6 flex justify-center'>
                      <div
                        ...
                        border border-[rgba(194,178,128,0.25)]
                        bg-[rgba(194,178,128,0.10)]
                      '
                      >
                        <Check className='h-4 w-4 text-[#C2B280]' />
                      </div>
                    </div>
                  )}
                </div>
        ...
        <FadeIn delay={0.5}>
          <div className='mt-12 text-center'>
            <p className='text-sm text-[rgba(229,221,200,0.45)]'>
